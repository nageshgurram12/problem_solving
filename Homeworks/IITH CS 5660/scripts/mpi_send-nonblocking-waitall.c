// Source: https://github.com/drahosp/PaPP/blob/master/examples/mpi/mpi_send-nonblocking-waitall.c
/*
...
The program consists of one process (process 0) which sends a message
